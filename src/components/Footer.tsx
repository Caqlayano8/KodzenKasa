...
export async function Footer({ settings }: { settings: FooterSettings }) {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300" style={{ backgroundColor: settings.footerBg }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-semibold text-white mb-4">Hizli Erisim</h3>
            <ul className="space-y-2">
              <li><Link href="/ilanlar?type=satilik" className="hover:text-white transition-colors">Satilik Ilanlar</Link></li>
              <li><Link href="/ilanlar?type=kiralik" className="hover:text-white transition-colors">Kiralik Ilanlar</Link></li>
              <li><Link href="/ilanlar?category=arsa" className="hover:text-white transition-colors">Arsa Ilanlari</Link></li>
              <li><Link href="/ilanlar?category=dukkan" className="hover:text-white transition-colors">Dukkan Ilanlari</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {customPages.map((page) => (
                <li key={page.slug}>
                  <Link href={`/sayfa/${page.slug}`} className="hover:text-white transition-colors">{page.title}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h3 className="font-semibold text-white mb-4">Iletisim</h3>
